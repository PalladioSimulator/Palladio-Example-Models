...
for /f "delims=" %%a IN ('dir /b *.designdecision') do (
 sed -i "s/sdq.ipd.uka.de\/DesignDecision\/1.0/sdq.ipd.uka.de\/DesignDecision\/3.0\" xmlns:specific=\"http:\/\/sdq.ipd.uka.de\/DesignDecision\/Specific\/3.0/g" "%%a"
 
sed -i "s/sdq.ipd.uka.de\/DesignDecision\/2.0\x22/sdq.ipd.uka.de\/DesignDecision\/3.0\" xmlns:specific=\"http:\/\/sdq.ipd.uka.de\/DesignDecision\/Specific\/3.0\x22>\n/g" "%%a"
